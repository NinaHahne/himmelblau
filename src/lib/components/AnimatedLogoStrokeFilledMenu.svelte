<script lang="ts">
  ...
  onMount(() => {
    ...
    const paths = document.querySelectorAll("#logo_menu #himmelblau > path") as NodeListOf<SVGPathElement>;
    ...
    // 📍 Animate i-dot:
    const iDot = document.querySelector("#logo_menu #i-dot") as SVGPathElement;
    ...
    // 🌿 Animate Flower Stem
    const stem = document.querySelector("#logo_menu #stem") as SVGPathElement;
    ...
    const bluebell = document.querySelector("#logo_menu #bluebell") as SVGPathElement;
    ...
    tl.to(
      bluebell,
      {
        stroke: "#5aaefc", // stroke color matches the fill
        fillOpacity: 1, // fade in the fill
        duration: 0.8,
        ease: "sine.out",
      },
      "+=0"
...
<svg
  ...
  stroke="currentColor"
  fill="none"
  class="h-auto w-full translate-x-[1%] text-navy-light transition-opacity duration-300 focus:outline-none"
...
>
  <defs id="defs1">
    <!-- not in use: -->
    <linearGradient id="bluebell-fill-gradient" x1="0%" y1="0%" x2="0%" y2="100%">
      <stop offset="0%" stop-color="#5aaefc" stop-opacity="1" />
      <stop offset="100%" stop-color="#5aaefc" stop-opacity="0" />
    </linearGradient>
    <mask id="bluebell-mask">
      <rect id="bluebell-fill-rect" x="0" y="0" width="100%" height="0" fill="white" />
    </mask>
  </defs>
  <g
    id="himmelblau"
  ...
  >
    ...
    />
    <ellipse id="i-dot" class="fill-current" cx="51.069542" cy="61.989346" rx="0.15265581" ry="0.35880628" />
    <g id="flower">
      <path id="stem" d="M 43.547491,64.528292 C 46.452855,48.194418 53.300106,44.426777 59.562083,44.704685" />
      <path
        id="bluebell"
        fill="#5aaefc"
        fill-opacity="0"
    ...
    <rect
      id="rect1"
      style="vector-effect:non-scaling-stroke;fill:none;stroke:none;stroke-width:0.0898743;stroke-dasharray:none;-inkscape-stroke:hairline"
      width="24.83853"
      height="31.156227"
      x="39.617882"
      y="41.292686"
