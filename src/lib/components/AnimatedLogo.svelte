<script lang="ts">
  ...
  onMount(() => {
    ...
    gsap.fromTo(
      "#i-dot ellipse",
      { opacity: 0 },
      { opacity: 1, duration: 0.5, ease: "power2.out", delay: durationOfAllPaths }
    );
  });
</script>
