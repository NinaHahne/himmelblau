<script lang="ts">
  ...
  onMount(() => {
    ...
    tl.to(stem, { opacity: 1, duration: 0.1, ease: "none", delay: initialDelay + stemDelay }, "+=0").to(
      stem,
    ...
    tl.to(leaf, { rotation: -14, duration: 0.4, ease: "power2.out", transformOrigin: "0% bottom" }, "<");
    ...
    tl.to(bluebell, { opacity: 1, duration: 0.1, ease: "none" }, "+=0.0").to(
      bluebell,
    ...
    tl.to(iDot, { opacity: 1, duration: 0.2, ease: "none" }, "-=1.5").to(
      iDot,
